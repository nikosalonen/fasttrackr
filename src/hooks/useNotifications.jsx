...
export const NotificationProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    setMilestoneNotifications(localStorage.getItem('milestoneNotifications') !== 'false')
  ...
  const showFastCompleteNotification = useCallback((duration) => {
    if (canShowNotifications()) {
  ...
  const showMilestoneNotification = useCallback((hours) => {

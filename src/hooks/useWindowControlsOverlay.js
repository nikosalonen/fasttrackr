...
export const useWindowControlsOverlay = () => {
  ...
  useEffect(() => {
    ...
    const checkSupport = () => {
      ...
      if (supported && navigator.windowControlsOverlay) {
        ...
        if (navigator.windowControlsOverlay.visible) {
          setTitleBarAreaRect(navigator.windowControlsOverlay.getTitlebarAreaRect())
        }
      }
    }
    ...
    if (isSupported && navigator.windowControlsOverlay) {
      ...
      return () => {
        navigator.windowControlsOverlay.removeEventListener('geometrychange', handleGeometryChange)
      }
    }
  }, [isSupported])

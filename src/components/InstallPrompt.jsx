...
const InstallPrompt = () => {
  ...
  useEffect(() => {
    ...
    const handleBeforeInstallPrompt = (e) => {
      ...
      setTimeout(() => {
        ...
        if (!hasBeenPrompted || (lastPrompted && parseInt(lastPrompted) < oneDayAgo)) {
          setShowPrompt(true)
        }
  ...
  const showInstallInstructions = () => {
    ...
    if (isIOS && isSafari) {
      instructions = 'To install FastTrackr:\n1. Tap the Share button at the bottom\n2. Tap "Add to Home Screen"\n3. Tap "Add" to confirm'
    } else if (navigator.userAgent.includes('Chrome')) {
      instructions = 'To install FastTrackr:\n1. Click the menu (⋮) in your browser\n2. Select "Install FastTrackr" or "Add to Home Screen"'
    } else {
      instructions = 'To install FastTrackr, look for "Install" or "Add to Home Screen" options in your browser menu.'
    }
    ...
    >
      ...
      <DialogContent>
        <Typography variant="body1" paragraph>
          Get the best experience with FastTrackr by installing it on your device!
        </Typography>

...
const HistoryScreen = () => {
  ...
  const handleDelete = () => {
    if (window.confirm('Are you sure you want to delete this fast? This action cannot be undone.')) {
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                  <Box sx={{ flex: 1 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1 }}>
                      ...
                      <Chip
                        icon={fast.completed ? <CompleteIcon /> : <IncompleteIcon />}
          ...
          <DialogContent>
            <Stack spacing={3} sx={{ mt: 1 }}>
              ...
              {editingFast?.startTime && editingFast?.endTime && (
                <Alert severity="info">
                  Duration: {formatDuration(editingFast.endTime.diff(editingFast.startTime))}
                </Alert>
              )}
            </Stack>
          </DialogContent>
